...
C55=(1/2).*((-2).*dq2.*(c2.*L.*ml2.*cos(phi)+c2.*l1.*ml2.*cos(phi+q1)+((-1) ...
  .*H2xx+H2yy+c2.^2.*ml2).*cos(phi+q1+q2)).*sin(phi+q1+q2)+(-1).*dq1.*(L.* ...
  (c1.*ml1+l1.*ml2).*sin(q1)+((-1).*H1xx+H1yy+c1.^2.*ml1+l1.^2.*ml2).*sin( ...
  2.*(phi+q1))+c1.*L.*ml1.*sin(2.*phi+q1)+L.*l1.*ml2.*sin(2.*phi+q1)+c2.* ...
  L.*ml2.*sin(q1+q2)+(-1).*H2xx.*sin(2.*(phi+q1+q2))+H2yy.*sin(2.*(phi+q1+ ...
  q2))+c2.^2.*ml2.*sin(2.*(phi+q1+q2))+c2.*L.*ml2.*sin(2.*phi+q1+q2)+2.* ...
  c2.*l1.*ml2.*sin(2.*(phi+q1)+q2))+(-1).*dphi.*((Hby+(-1).*Hbz+L.^2.*( ...
...
C56=(1/2).*(dq2.*(H2zz+c2.^2.*ml2+c2.*l1.*ml2.*cos(q2)+c2.*L.*ml2.*cos(q1+ ...
  ...
  ml2+L.*(c1.*ml1+l1.*ml2).*cos(q1)+((-1).*H1xx+H1yy+c1.^2.*ml1+l1.^2.* ...
  ml2).*cos(2.*(phi+q1))+c1.*L.*ml1.*cos(2.*phi+q1)+L.*l1.*ml2.*cos(2.* ...
  phi+q1)+2.*c2.*l1.*ml2.*cos(q2)+c2.*L.*ml2.*cos(q1+q2)+(-1).*H2xx.*cos( ...
  ...
  l1.^2.*ml2+(Hby+(-1).*Hbz+L.^2.*(ml1+ml2)).*cos(2.*phi)+2.*L.*(c1.*ml1+ ...
  l1.*ml2).*cos(q1)+((-1).*H1xx+H1yy+c1.^2.*ml1+l1.^2.*ml2).*cos(2.*(phi+ ...
  q1))+2.*c1.*L.*ml1.*cos(2.*phi+q1)+2.*L.*l1.*ml2.*cos(2.*phi+q1)+2.*c2.* ...
  l1.*ml2.*cos(q2)+2.*c2.*L.*ml2.*cos(q1+q2)+(-1).*H2xx.*cos(2.*(phi+q1+ ...
  ...
  Hbz+(-1).*c1.^2.*ml1+(-1).*L.^2.*ml1+(-1).*c2.^2.*ml2+(-1).*L.^2.*ml2+( ...
  -1).*l1.^2.*ml2+(-1).*(Hby+(-1).*Hbz+L.^2.*(ml1+ml2)).*cos(2.*phi)+(-2) ...
  .*L.*(c1.*ml1+l1.*ml2).*cos(q1)+H1xx.*cos(2.*(phi+q1))+(-1).*H1yy.*cos( ...
  2.*(phi+q1))+(-1).*c1.^2.*ml1.*cos(2.*(phi+q1))+(-1).*l1.^2.*ml2.*cos( ...
  2.*(phi+q1))+(-2).*c1.*L.*ml1.*cos(2.*phi+q1)+(-2).*L.*l1.*ml2.*cos(2.* ...
  phi+q1)+(-2).*c2.*l1.*ml2.*cos(q2)+(-2).*c2.*L.*ml2.*cos(q1+q2)+H2xx.* ...
  cos(2.*(phi+q1+q2))+(-1).*H2yy.*cos(2.*(phi+q1+q2))+(-1).*c2.^2.*ml2.* ...
...
C57=(1/2).*(dpsi.*(H1zz+H2zz+c1.^2.*ml1+c2.^2.*ml2+l1.^2.*ml2+L.*(c1.*ml1+ ...
  ...
  ml2.*cos(q2)+c2.*L.*ml2.*cos(q1+q2)+(-1).*H2xx.*cos(2.*(phi+q1+q2))+ ...
  H2yy.*cos(2.*(phi+q1+q2))+c2.^2.*ml2.*cos(2.*(phi+q1+q2))+c2.*L.*ml2.* ...
  cos(2.*phi+q1+q2)+2.*c2.*l1.*ml2.*cos(2.*phi+2.*q1+q2)).*cos(th)+(-1).* ...
  dth.*(L.*(c1.*ml1+l1.*ml2).*sin(q1)+((-1).*H1xx+H1yy+c1.^2.*ml1+l1.^2.* ...
  ml2).*sin(2.*(phi+q1))+c1.*L.*ml1.*sin(2.*phi+q1)+L.*l1.*ml2.*sin(2.* ...
  phi+q1)+c2.*L.*ml2.*sin(q1+q2)+(-1).*H2xx.*sin(2.*(phi+q1+q2))+H2yy.* ...
...
C58=(1/2).*dpsi.*(H2zz+c2.^2.*ml2+c2.*l1.*ml2.*cos(q2)+c2.*L.*ml2.*cos(q1+ ...
  q2)+(-1).*H2xx.*cos(2.*(phi+q1+q2))+H2yy.*cos(2.*(phi+q1+q2))+c2.^2.* ...
  ml2.*cos(2.*(phi+q1+q2))+c2.*L.*ml2.*cos(2.*phi+q1+q2)+c2.*l1.*ml2.*cos( ...
  2.*(phi+q1)+q2)).*cos(th)+(-1).*dth.*(c2.*L.*ml2.*cos(phi)+c2.*l1.*ml2.* ...
  cos(phi+q1)+((-1).*H2xx+H2yy+c2.^2.*ml2).*cos(phi+q1+q2)).*sin(phi+q1+ ...
  q2);
